...
<?php else : ?>
    ...
    <div class="content">
        <p>If you don't have a login, please <a href=" <?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>?cp=register">register</a>.<a href=" <?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>?cp=register">Forgot your password?</a></p>
