...
if (isset($_GET['sure'])) {
    ...
    <div class="content warn">
        ...
        <a href="/index.php?cp=account_deletion&sure">
            <input type="button" style="background-color: #ec8f8f !important" value="Account definitiv l&ouml;schen!!" />
        </a>
        <a href="/index.php?cp=E404">
            <input type="button" style="background-color: #b7e2ff !important" value="Wat willscht du??" />
        </a>
    </div>
<?php } ?>